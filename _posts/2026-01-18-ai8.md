...
- On the other hand, don't go nuts. Refer casually to general engineering knowledge about how things are usually done; [Claude has spent $1.5bn on books and has read them all](https://www.bbc.co.uk/news/articles/c5y4jpg922qo), so there's a lot you don't need to spell out, just set the direction.
