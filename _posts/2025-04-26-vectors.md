...
With parentheses, we mean that it operates on two vectors, distinct from the action of a covector on a vector. And we can link this back to the matrix $g$ as follows:
