...
Last July I noted down my thoughts on [[Redux|What's good about Redux]] with some hints of the concerns that eventually led to [[Immuto|Immuto - Strongly Typed Redux Composition]].

I've since rediscovered my love of `observable` and `computed` via [[MobX|MobX - Like React, but for Data]], which is like the good parts of [Knockout.js](http://knockoutjs.com) made even better by a very careful, thoughtful implementation.
