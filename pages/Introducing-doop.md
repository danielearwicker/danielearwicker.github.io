...
So I wanted to see if something simpler could be done using the built-in metaprogramming capabilities in TypeScript, namely <a href="https://github.com/Microsoft/TypeScript-Handbook/blob/master/pages/Decorators.md">decorators</a>. And it can! And it's not as ugly as it might be! And there's a nice hack hiding under it!
