...
A few months ago [I joined FISCAL](http://www.fiscaltechnologies.com/news/pr/pr11-08-17.html) to pitch in and help to *"bend technology to our will"*, as [our CTO](https://durdle.com/) puts it. It turns out that this [quite often involves LEGO](http://www.fiscaltechnologies.com/lego/), which I could hardly be more pleased about. But sometimes we work on software too.
...
Sadly, Ember bet heavily on Bower. When I found an `npm` package I wanted to use, I tried following [the instructions](https://simplabs.com/blog/2017/02/13/npm-libs-in-ember-cli.html). I know the idea isn't to be *actively hostile* to users trying to do this... it just felt like it.
