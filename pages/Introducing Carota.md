...
*This project was a lot of fun, but it has a big roadblock that has to be overcome by any text-based project: internationalisation. Hence I don't see it being 
generally useful outside of Western-language-only projects without a lot more work.*
...
their *Pages* word processor, and use your browser to look at how they do it: the text is rendered using absolute, meticulously positioned SVG elements, so 
...
meet future needs. I've designed it from the ground up to be hacked by other people to do whatever *they* want.
